        ...
        {props.friends.map(friends => (
          <li key={friends.name}>
            <div className="row card shadow bg-light center m-5 pt-3">
              ...
              <button type="tel" className="card-footer pt-3" >
                <svg className="bi bi-phone" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              {friends.phone}<DeleteBtn onClick={() => deleteFriend(friends._id)} /></button></div>
