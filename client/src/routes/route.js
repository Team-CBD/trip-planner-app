...
export default function route() {
  return (
    ...
    <div className="nav-wrapper container">
      ...
      <ul className="row">
        <li className="btn btn-default mt-1 mr-1">
        ...
        <li className="btn btn-default mt-1 mr-1">
          <Link to="/converter"><svg class="converter" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
