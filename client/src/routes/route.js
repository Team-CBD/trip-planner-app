  ...
  return (
    ...
    <div className="nav-wrapper container">
      ...
      <ul className="row">
        ...
        <li className="btn neu btn-default mt-1 mr-1">
          <Link to="/EventCreate"><svg className="bi bi-cursor" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="btn neu btn-default mt-1 mr-1">
          <Link to="/converter"><svg className="bi bi-arrow-left-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
