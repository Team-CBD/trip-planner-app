        ...
        <div className="col-lg-8 offset-lg-2">
            <form name="form" onSubmit={this.handleSubmit}> 
                <div className="form-group">
                    ...
                    <input className="p-2 neuflip" type="text" name="email" onChange={this.handleChange} />
                </div>
                <div className="form-group">
                    <label className="pr-2">Password: </label>
                        <input className="p-2 neuflip" type="text" name="password" onChange={this.handleChange}/>
                </div>
                <div>
                    <button className="btn button btn-primary text-dark neu">Login</button>
                </div>
            </form>
        </div>
    );
