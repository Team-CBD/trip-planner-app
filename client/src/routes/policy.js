...
function Header () {
    return (
       ...
       <div className="col-md-12">
                ...
                <p>Last updated: 4/1/2020
                My Company Team-CBD ("us", "we", or "our") operates http://www.mysite.com Team-CBD (the
                ...
                This Privacy Policy is effective as of 4/1/2020 and will remain in effect except with respect to
                any
                ...
                Disclaimer: Legal information is not legal advice. Read the disclaimer.</p>
        </div>
        </div>
        </div>
    )
